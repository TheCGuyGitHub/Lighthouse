...
import { type BulletLegendItemInterface, CurveType, Scale } from '@unovis/ts'
...
<template>
  <div :class="cn('w-full h-[400px] flex flex-col items-end', $attrs.class ?? '')">
    ...
    <VisXYContainer :style="{ height: isMounted ? '100%' : 'auto' }" :margin="{ left: 20, right: 20 }" :data="data" :yDomain="yDomain" :xDomain="xDomain">
